...
```javascript
import sub from 'https://cdn.jsdelivr.net/gh/stdlib-js/number-uint8-base-sub@v0.1.1-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/number-uint8-base-sub/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/number-uint8-base-sub/actions/workflows/test.yml?query=branch:v0.1.1
